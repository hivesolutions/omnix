...
{% block content %}
    <form action="{{ url_for('update_entity', id = media.object_id) }}" method="post" class="form">
        <div class="label">
            <label>Description</label>
        </div>
        <div class="input">
            <input class="text-field" name="description" placeholder="eg: a simple description" value="{{ entity.description }}"
